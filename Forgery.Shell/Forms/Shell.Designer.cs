...
using Forgery.Shell.Controls;

namespace Forgery.Shell.Forms
{
    partial class Shell
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.DocumentTabs = new Forgery.Shell.Controls.ClosableTabControl();
            this.RightSidebar = new Forgery.Shell.Controls.DockedPanel();
            this.RightSidebarContainer = new Forgery.Shell.Controls.SidebarContainer();
            this.LeftSidebar = new Forgery.Shell.Controls.DockedPanel();
            this.LeftSidebarContainer = new Forgery.Shell.Controls.SidebarContainer();
            this.BottomSidebar = new Forgery.Shell.Controls.DockedPanel();
            ...
            this.DocumentTabs.RequestClose += new Forgery.Shell.Controls.ClosableTabControl.RequestCloseEventHandler(this.RequestClose);
        ...
        private Forgery.Shell.Controls.DockedPanel BottomSidebar;
        private Forgery.Shell.Controls.DockedPanel RightSidebar;
        private Forgery.Shell.Controls.DockedPanel LeftSidebar;
        private System.Windows.Forms.Panel DocumentContainer;
        private Forgery.Shell.Controls.ClosableTabControl DocumentTabs;
