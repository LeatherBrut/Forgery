...
namespace Forgery.Editor.Update
{
    ...
    public class UpdateChecker : IInitialiseHook, ISettingsContainer
    {
        ...
        public Task OnInitialise()
        {
            ...
            Oy.Subscribe<string>("Forgery:Editor:UpdateDownloaded", OnUpdateDownloaded);
        ...
        {
            Oy.Publish("Command:Run", new CommandMessage("Forgery:Editor:CheckForUpdates", new {Silent = true}));
        }

        public string Name => "Forgery.Editor.UpdateChecker";
