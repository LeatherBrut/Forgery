...
namespace Forgery.Editor.Update
{
    public partial class UpdaterForm : Form
    {
        ...
        private Task DownloadUpdate(string url, string file, CancellationToken token)
        {
            ...
            wc.Headers.Add(HttpRequestHeader.UserAgent, "LogicAndTrick/Forgery");
            ...
            {
                tcs.SetResult(true);
                Oy.Publish("Forgery:Editor:UpdateDownloaded", _filename);
        ...
        {
            Process.Start("https://github.com/LogicAndTrick/Forgery/releases");
        }
    }
}
