...
namespace Forgery.Editor.Update
{
    [AutoTranslate]
    [Export(typeof(ICommand))]
    [MenuItem("Help", "", "Update", "B")]
    [CommandID("Forgery:Editor:CheckForUpdates")]
    public class CheckForUpdates : ICommand
    {
        ...
        public string NoUpdatesMessage { get; set; } = "This version of Forgery is currently up-to-date.";
        ...
        private const string GithubReleasesApiUrl = "https://api.github.com/repos/LogicAndTrick/Forgery/releases?page=1&per_page=1";
        private const string ForgeryWebsiteUpdateSource = "http://Forgery-editor.com/version.txt";
        ...
        public async Task Invoke(IContext context, CommandParameters parameters)
        {
            ...
            var result = await GetUpdateCheckResult(ForgeryWebsiteUpdateSource);
        ...
        private async Task<UpdateReleaseDetails> GetLatestReleaseDetails()
        {
            ...
            {
                wc.Headers.Add(HttpRequestHeader.UserAgent, "LogicAndTrick/Forgery-Editor");
