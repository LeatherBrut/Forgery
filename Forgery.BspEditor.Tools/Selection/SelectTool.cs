...
using Forgery.BspEditor.Tools.Selection.TransformationHandles;
using Forgery.BspEditor.Tools.Widgets;
...
namespace Forgery.BspEditor.Tools.Selection
{
    ...
    public class SelectTool : BaseDraggableTool, ISettingsContainer
    {
        ...
        string ISettingsContainer.Name => "Forgery.BspEditor.Tools.SelectTool";
