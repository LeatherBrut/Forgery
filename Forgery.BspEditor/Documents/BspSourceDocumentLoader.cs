...
using Forgery.BspEditor.Environment.Controls;
using Forgery.BspEditor.Environment.Empty;
using Forgery.BspEditor.Primitives;
using Forgery.BspEditor.Providers;
...
namespace Forgery.BspEditor.Documents
{
    /// <summary>
