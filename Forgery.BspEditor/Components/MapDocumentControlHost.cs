...
using Forgery.BspEditor.Controls;
using Forgery.BspEditor.Controls.Layout;
...
namespace Forgery.BspEditor.Components
{
    ...
    public class MapDocumentControlHost : UserControl, ISettingsContainer, IUIShutdownHook, IUIStartupHook
    {
        ...
        string ISettingsContainer.Name => "Forgery.BspEditor.Components.MapDocumentControlHost";
